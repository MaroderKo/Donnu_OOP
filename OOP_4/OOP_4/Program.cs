    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("a) вводити координати точки з клавіатури(файлу);\nb) виводити координати точки на екран(файл);\nc) знаходити відстані між двома точками;\nd) знаходити найменшу / найбільшу відстань від заданої точки, до множини точок(заданих масивом). ");
